...
contract('MemeOfTheDay (proxy)', function(accounts) {
    it('should mints token with given hash', async function () {
        console.log("Deploying Proxy...");
        this.meme1 = await deployProxy(MTD, {initializer: 'initialize'});
    ...
    it('should keep MemesCount after upgradeProxy', async function () {
        ...
        this.meme2 = await upgradeProxy(this.meme1.address, MTDV2, {initializer: 'initialize'});
