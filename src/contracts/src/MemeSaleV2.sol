...
import "./MemeOfTheDayV2.sol";
import "./MOTDTreasuryV2.sol";
import "./MOTDSaleParametersProviderV2.sol";
 ...
 * @author MemeOfTheDay
 */
contract MemeSaleV2 is EIP712Domain, Initializable{
    //Removed because sol 0.8.0 already checks for over and underflow
    ...
    MemeOfTheDayV2 public memeOfTheDay;
    MOTDTreasuryV2 public memeOfTheDayTreasury;
    MOTDSaleParametersProviderV2 memeOfTheDaySaleParametersProvider;
    ...
    function initialize(
        ...
        string memory version
         ...
         memeOfTheDay = MemeOfTheDayV2(memeOfTheDayAddress);

        memeOfTheDayTreasury = MOTDTreasuryV2(motdTreasuryAddress);

        memeOfTheDaySaleParametersProvider = MOTDSaleParametersProviderV2(memeOfTheDaySaleParametersProviderAddress);
